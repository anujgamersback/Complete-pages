  ...
  return (
    ...
    >
      <div className="flex flex-row gap-[9px] items-center w-[614px] h-8  mx-auto justify-center">
        ...
        //   onClick={() => navigate(routeConstants.NAVIGATEHOME)}
        >
        ...
        //   onClick={() => navigate(routeConstants.NAVIGATEDISCOVER)}
        >
        ...
        //   onClick={() => navigate(routeConstants.NAVIGATEGAMEHOME)}
        >
        ...
        //   onClick={() => navigate(routeConstants.NAVIGATEGAMEFOLIO)}
        >
